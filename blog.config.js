...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-gamma-five-16.vercel.app/about', // 网站地址
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Yuzai 的学习笔记', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
